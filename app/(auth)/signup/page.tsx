          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-4">
              <Input
                type="text"
                placeholder="Nombre"
                {...register('nombre', { required: { value: true, message: 'Este campo es obligatorio'} })}
              />

              {errors.nombre && typeof errors.nombre.message === "string" &&  <span className="text-sm text-red-500">{errors.nombre.message}</span>}
              ...
              />
              {errors.edad && typeof errors.edad.message === "string" &&  <p className="text-sm text-red-500">{errors.edad.message}</p>}
              ...
              />
              {errors.email && typeof errors.email.message === "string" &&  <p className="text-sm text-red-500">{errors.email.message}</p>}
              ...
              />
              {errors.contrasena && typeof errors.contrasena.message === "string" &&  <p className="text-sm text-red-500">{errors.contrasena.message}</p>}
